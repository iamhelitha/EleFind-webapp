  ...
  return (
    <div className="absolute top-4 right-4 z-[1000]">
      ...
      <button
        ...
        className="mb-2 flex items-center gap-1.5 rounded-lg bg-[rgba(245,234,216,0.92)] backdrop-blur-md px-3 py-2 text-sm font-medium text-ink shadow-md hover:bg-[rgba(245,234,216,0.92)] backdrop-blur-md transition-colors border border-[rgba(32,30,29,0.14)]"
      >
      ...
      {/* Controls panel */}
      {!collapsed && (
        <div className="w-64 rounded-xl bg-[rgba(245,234,216,0.92)] backdrop-blur-md border border-[rgba(32,30,29,0.14)] shadow-lg p-4 space-y-4 animate-fade-in">
          ...
          {/* Confidence filter */}
          <div>
            <label className="text-xs font-medium text-[rgba(32,30,29,0.55)] block mb-1">
          ...
          {/* Legend */}
          <div className="border-t border-[rgba(32,30,29,0.14)] pt-3">
            <h4 className="text-xs font-medium text-[rgba(32,30,29,0.55)] mb-2">Legend</h4>
