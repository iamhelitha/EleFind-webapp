    ...
    <div className="space-y-1.5">
      ...
      {sorted.length === 0 ? (
        <div className="rounded-lg border-2 border-dashed border-[rgba(32,30,29,0.14)] p-4 text-center">
          <p className="text-xs text-[rgba(32,30,29,0.55)]">No detections recorded yet.</p>
          <p className="text-[10px] text-[rgba(32,30,29,0.55)] mt-0.5">
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected
                    ? "border-sage-500 bg-sand-surface/60 ring-1 ring-green-400"
                    : "border-[rgba(32,30,29,0.14)] hover:border-sage-300 hover:bg-[rgba(32,30,29,0.06)]/40"
                  }
                `}
              >
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[10px] text-[rgba(32,30,29,0.55)]/70 tabular-nums">
                ...
                <MapPin
                  className={`h-3.5 w-3.5 shrink-0 transition-colors ${
                    isSelected ? "text-sage-700" : "text-[rgba(32,30,29,0.55)]"
                  }`}
                />
              </button>
            );
