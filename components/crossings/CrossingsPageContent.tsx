 ...
 *
 * Handles interactive state (selected zone) while receiving
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        ...
        <div className="lg:col-span-3 h-[500px] lg:h-[600px] rounded-xl overflow-hidden border border-card-border">
          <EleMap
            detections={[]}
            crossingZones={initialCrossings}
            filters={MAP_FILTERS}
          />
        </div>
        ...
        <div className="lg:col-span-2 space-y-3">
          <h2 className="font-heading text-lg font-bold text-green-900">
            Zones ({initialCrossings.length})
          </h2>

          {initialCrossings.length === 0 ? (
