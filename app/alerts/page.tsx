...
export default function AlertsPage() {
  ...
  function handleSave() {
    ...
    toast.success(
      `Coming soon — alert delivery isn't built yet. These settings would register ${village}, ${district} at ${radiusKm} km via ${active.join(" + ")}.`,
      { duration: 6000 }
    );
  }
    ...
    <div className="animate-fade-in bg-sand">
      ...
      <div className="border-b border-accent-300 bg-accent-100 px-4 py-2.5 sm:px-6 lg:px-8">
        <p className="mx-auto m-0 flex max-w-7xl items-start gap-2 text-[12.5px] leading-[1.5] text-accent-900">
          ...
          <span>
            <strong>Coming soon.</strong> This screen previews the alerts
            interface — subscriptions aren&rsquo;t stored and no SMS is sent
            yet. Controls work so the flow can be reviewed.
          </span>
        </p>
      </div>
