      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-card-border bg-white p-6 shadow-sm">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-3 rounded-lg border border-card-border px-4 py-2.5 text-sm font-medium text-green-900 hover:bg-green-50 disabled:opacity-60 transition-colors"
          >
            {googleLoading ? (
              <>
                <Spinner size="sm" />
